    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.contentBody}>
          ...
          <section className={styles.sectionLight}>
            <h2>Projects</h2>
            <Card interactive={true} className={styles.projectCard}>
              ...
              <div>
                ...
                <ul className={styles.activities}>
                  <li>
                    Developed native iOS application showing customer utility
                    usage and billing information. Customers can input or scan
                    credit card information for convenient billing payment.
                  </li>
                  <li>
            ...
            <Card interactive={true} className={styles.projectCard}>
              ...
              <div>
                ...
                <ul className={styles.activities}>
                  <li>
                    Produced the graphic design for all screen layouts with full
                    color mockups.
                  </li>
                  <li>
                    Developed native Android application showing customer
                    utility usage and billing information. Customers can input
                    or scan credit card information for convenient billing
                    payment.
                  </li>
                  <li>
                    Used Android Studio to program the UI using the Kotlin
                    programming language.
                  </li>
                </ul>
                <div className={styles.tagList}>
            ...
            <Card interactive={true} className={styles.projectCard}>
              ...
              <div>
                ...
                <ul className={styles.activities}>
                  ...
                  <li>
                    Developed React/TypeScript single page web application used
                    to manage boil water notices. The application queried an
                    ArcGIS server for water meter locations. Users can draw
                    water outage regions to capture customer locations for
                    notifications.
                  </li>
                </ul>
                <div className={styles.tagList}>
            ...
            <Card interactive={true} className={styles.projectCard}>
              ...
              <div>
                ...
                <ul className={styles.activities}>
                  ...
                  <li>
                    Developed Angular/TypeScript single page web application
                    used by insurance marketers to manage their insurance quotes
                    and policies.
                  </li>
                  <li>
                    Developed Node.js/TypeScript backend Express app run in
                    Google Cloud Platform Kubernetes containers. Also wrote
                    backend pub/sub import processes using cloud functions.
                  </li>
                </ul>
                <div className={styles.tagList}>
                  <Tag icon="console" minimal={true} round={true}>
